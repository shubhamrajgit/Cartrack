...
class UserSQLiteService: SQLiteService {
    ...
    private func createUserTable() {
                              ...
                              nil) == SQLITE_OK
        {
            ...
            print("CREATE USER TABLE statement could not be prepared.")
        }
    ...
    func insertUserData(id: Int,
        ...
        guard !checkUsernameAlreadyExists(username: username) else {
            print("Can not insert data as username already exists.")
            return false
        }
        ...
        if sqlite3_prepare_v2(db,
            ...
            print("INSERT query could not be prepared.")
        }
    ...
    func checkUsernameAlreadyExists(username: String) -> Bool {
        ...
        if sqlite3_prepare_v2(db,
            ...
            print("SELECT query could not be prepared.")
        }
